...
namespace PowerUtils.Results.Validations.Tests.IfRules.Dates
{
    public class IfLessThanUtcTodayValidationTests
    {
        ...
        {
            // Arrange
            var dateOfBirth = DateOnly.FromDateTime(DateTime.UtcNow.AddSeconds(-2));
        ...
        {
            // Arrange
            var dateOfBirth = DateOnly.FromDateTime(DateTime.UtcNow.Date);
        ...
        {
            // Arrange
            DateOnly? dateOfBirth = DateOnly.FromDateTime(DateTime.UtcNow.Date);
        ...
        {
            // Arrange
            DateOnly? dateOfBirth = DateOnly.FromDateTime(DateTime.UtcNow.AddMilliseconds(500));
        ...
        {
            // Arrange
            DateOnly? dateOfBirth = DateOnly.FromDateTime(DateTime.UtcNow.AddSeconds(2));
        ...
        {
            // Arrange
            DateOnly? dateOfBirth = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(-20));

            var expectedProperty = "fake Prop DateOnly";
            var expectedCode = "fake Code DateOnly";
            var expectedDescription = $"Fake desc DateOnly > '{expectedProperty}'";
